...
import com.xuelangyun.shangfei.sacsc.domain.entity.CsRunAirPlan;
...
/**
 * @author zijian.qjd
 * @since 2022/2/22 10:05
 */
public interface CsRunAirPlanMapper extends BaseMapper<CsRunAirPlan> {
  ...
  @Select(
      "<script>"
          ...
          + " from (select a.*, b.code from cs_run_air_plan a left join cs_run_company_mark b on a.airline_company = b.company) a "
          ...
          + "</script>")
  List<CsRunAirPlan> selectWithCompanyAndDay(
      @Param("companyCode") String companyCode, @Param("planMaxTime") Date planMaxTime);
}
